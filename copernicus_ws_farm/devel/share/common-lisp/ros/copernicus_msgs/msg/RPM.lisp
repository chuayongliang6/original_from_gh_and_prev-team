...
(cl:defmethod cl:initialize-instance :after ((m <RPM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RPM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name copernicus_msgs-msg:<RPM> is deprecated: use copernicus_msgs-msg:RPM instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <RPM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:left-val is deprecated.  Use copernicus_msgs-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <RPM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:right-val is deprecated.  Use copernicus_msgs-msg:right instead.")
  (right m))

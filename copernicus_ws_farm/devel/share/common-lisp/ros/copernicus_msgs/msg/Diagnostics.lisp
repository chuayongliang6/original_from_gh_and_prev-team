...
(cl:defmethod cl:initialize-instance :after ((m <Diagnostics>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Diagnostics)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name copernicus_msgs-msg:<Diagnostics> is deprecated: use copernicus_msgs-msg:Diagnostics instead.")))

(cl:ensure-generic-function 'LOWBATTERY_FLAG-val :lambda-list '(m))
(cl:defmethod LOWBATTERY_FLAG-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:LOWBATTERY_FLAG-val is deprecated.  Use copernicus_msgs-msg:LOWBATTERY_FLAG instead.")
  (LOWBATTERY_FLAG m))

(cl:ensure-generic-function 'CHARGING_FLAG-val :lambda-list '(m))
(cl:defmethod CHARGING_FLAG-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:CHARGING_FLAG-val is deprecated.  Use copernicus_msgs-msg:CHARGING_FLAG instead.")
  (CHARGING_FLAG m))

(cl:ensure-generic-function 'MOTOR_ALARM_FLAG-val :lambda-list '(m))
(cl:defmethod MOTOR_ALARM_FLAG-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:MOTOR_ALARM_FLAG-val is deprecated.  Use copernicus_msgs-msg:MOTOR_ALARM_FLAG instead.")
  (MOTOR_ALARM_FLAG m))

(cl:ensure-generic-function 'BMS_ALARM_FLAG-val :lambda-list '(m))
(cl:defmethod BMS_ALARM_FLAG-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_ALARM_FLAG-val is deprecated.  Use copernicus_msgs-msg:BMS_ALARM_FLAG instead.")
  (BMS_ALARM_FLAG m))

(cl:ensure-generic-function 'HIGH_TEMP_FLAG-val :lambda-list '(m))
(cl:defmethod HIGH_TEMP_FLAG-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:HIGH_TEMP_FLAG-val is deprecated.  Use copernicus_msgs-msg:HIGH_TEMP_FLAG instead.")
  (HIGH_TEMP_FLAG m))

(cl:ensure-generic-function 'COMM_ERROR_FLAG-val :lambda-list '(m))
(cl:defmethod COMM_ERROR_FLAG-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:COMM_ERROR_FLAG-val is deprecated.  Use copernicus_msgs-msg:COMM_ERROR_FLAG instead.")
  (COMM_ERROR_FLAG m))

(cl:ensure-generic-function 'BMS_SOC-val :lambda-list '(m))
(cl:defmethod BMS_SOC-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_SOC-val is deprecated.  Use copernicus_msgs-msg:BMS_SOC instead.")
  (BMS_SOC m))

(cl:ensure-generic-function 'BMS_SOH-val :lambda-list '(m))
(cl:defmethod BMS_SOH-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_SOH-val is deprecated.  Use copernicus_msgs-msg:BMS_SOH instead.")
  (BMS_SOH m))

(cl:ensure-generic-function 'BMS_Voltage-val :lambda-list '(m))
(cl:defmethod BMS_Voltage-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_Voltage-val is deprecated.  Use copernicus_msgs-msg:BMS_Voltage instead.")
  (BMS_Voltage m))

(cl:ensure-generic-function 'BMS_Current-val :lambda-list '(m))
(cl:defmethod BMS_Current-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_Current-val is deprecated.  Use copernicus_msgs-msg:BMS_Current instead.")
  (BMS_Current m))

(cl:ensure-generic-function 'BMS_voltageDiff-val :lambda-list '(m))
(cl:defmethod BMS_voltageDiff-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_voltageDiff-val is deprecated.  Use copernicus_msgs-msg:BMS_voltageDiff instead.")
  (BMS_voltageDiff m))

(cl:ensure-generic-function 'BMS_tempDiff-val :lambda-list '(m))
(cl:defmethod BMS_tempDiff-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_tempDiff-val is deprecated.  Use copernicus_msgs-msg:BMS_tempDiff instead.")
  (BMS_tempDiff m))

(cl:ensure-generic-function 'BMS_BCUMode-val :lambda-list '(m))
(cl:defmethod BMS_BCUMode-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_BCUMode-val is deprecated.  Use copernicus_msgs-msg:BMS_BCUMode instead.")
  (BMS_BCUMode m))

(cl:ensure-generic-function 'BMS_Alarm-val :lambda-list '(m))
(cl:defmethod BMS_Alarm-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:BMS_Alarm-val is deprecated.  Use copernicus_msgs-msg:BMS_Alarm instead.")
  (BMS_Alarm m))

(cl:ensure-generic-function 'M_State-val :lambda-list '(m))
(cl:defmethod M_State-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_State-val is deprecated.  Use copernicus_msgs-msg:M_State instead.")
  (M_State m))

(cl:ensure-generic-function 'M_Alarm-val :lambda-list '(m))
(cl:defmethod M_Alarm-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_Alarm-val is deprecated.  Use copernicus_msgs-msg:M_Alarm instead.")
  (M_Alarm m))

(cl:ensure-generic-function 'M_Power-val :lambda-list '(m))
(cl:defmethod M_Power-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_Power-val is deprecated.  Use copernicus_msgs-msg:M_Power instead.")
  (M_Power m))

(cl:ensure-generic-function 'M_Voltage-val :lambda-list '(m))
(cl:defmethod M_Voltage-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_Voltage-val is deprecated.  Use copernicus_msgs-msg:M_Voltage instead.")
  (M_Voltage m))

(cl:ensure-generic-function 'M_Current-val :lambda-list '(m))
(cl:defmethod M_Current-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_Current-val is deprecated.  Use copernicus_msgs-msg:M_Current instead.")
  (M_Current m))

(cl:ensure-generic-function 'M_Comm-val :lambda-list '(m))
(cl:defmethod M_Comm-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_Comm-val is deprecated.  Use copernicus_msgs-msg:M_Comm instead.")
  (M_Comm m))

(cl:ensure-generic-function 'Relay_Temp-val :lambda-list '(m))
(cl:defmethod Relay_Temp-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:Relay_Temp-val is deprecated.  Use copernicus_msgs-msg:Relay_Temp instead.")
  (Relay_Temp m))

(cl:ensure-generic-function 'PowerConn_Temp-val :lambda-list '(m))
(cl:defmethod PowerConn_Temp-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:PowerConn_Temp-val is deprecated.  Use copernicus_msgs-msg:PowerConn_Temp instead.")
  (PowerConn_Temp m))

(cl:ensure-generic-function 'PreCharge_Temp-val :lambda-list '(m))
(cl:defmethod PreCharge_Temp-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:PreCharge_Temp-val is deprecated.  Use copernicus_msgs-msg:PreCharge_Temp instead.")
  (PreCharge_Temp m))

(cl:ensure-generic-function 'Power_Supply_Temp-val :lambda-list '(m))
(cl:defmethod Power_Supply_Temp-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:Power_Supply_Temp-val is deprecated.  Use copernicus_msgs-msg:Power_Supply_Temp instead.")
  (Power_Supply_Temp m))

(cl:ensure-generic-function 'Battery_In_Volt-val :lambda-list '(m))
(cl:defmethod Battery_In_Volt-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:Battery_In_Volt-val is deprecated.  Use copernicus_msgs-msg:Battery_In_Volt instead.")
  (Battery_In_Volt m))

(cl:ensure-generic-function 'PRE_CHARGE_Volt-val :lambda-list '(m))
(cl:defmethod PRE_CHARGE_Volt-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:PRE_CHARGE_Volt-val is deprecated.  Use copernicus_msgs-msg:PRE_CHARGE_Volt instead.")
  (PRE_CHARGE_Volt m))

(cl:ensure-generic-function 'HW_ESTOP_Volt-val :lambda-list '(m))
(cl:defmethod HW_ESTOP_Volt-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:HW_ESTOP_Volt-val is deprecated.  Use copernicus_msgs-msg:HW_ESTOP_Volt instead.")
  (HW_ESTOP_Volt m))

(cl:ensure-generic-function 'SW_ESTOP_Volt-val :lambda-list '(m))
(cl:defmethod SW_ESTOP_Volt-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:SW_ESTOP_Volt-val is deprecated.  Use copernicus_msgs-msg:SW_ESTOP_Volt instead.")
  (SW_ESTOP_Volt m))

(cl:ensure-generic-function 'Motor_Alarm_Code-val :lambda-list '(m))
(cl:defmethod Motor_Alarm_Code-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:Motor_Alarm_Code-val is deprecated.  Use copernicus_msgs-msg:Motor_Alarm_Code instead.")
  (Motor_Alarm_Code m))

(cl:ensure-generic-function 'Motor_Fun_Fail-val :lambda-list '(m))
(cl:defmethod Motor_Fun_Fail-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:Motor_Fun_Fail-val is deprecated.  Use copernicus_msgs-msg:Motor_Fun_Fail instead.")
  (Motor_Fun_Fail m))

(cl:ensure-generic-function 'M_INIT-val :lambda-list '(m))
(cl:defmethod M_INIT-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_INIT-val is deprecated.  Use copernicus_msgs-msg:M_INIT instead.")
  (M_INIT m))

(cl:ensure-generic-function 'M_CW-val :lambda-list '(m))
(cl:defmethod M_CW-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_CW-val is deprecated.  Use copernicus_msgs-msg:M_CW instead.")
  (M_CW m))

(cl:ensure-generic-function 'M_CCW-val :lambda-list '(m))
(cl:defmethod M_CCW-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_CCW-val is deprecated.  Use copernicus_msgs-msg:M_CCW instead.")
  (M_CCW m))

(cl:ensure-generic-function 'M_STOP-val :lambda-list '(m))
(cl:defmethod M_STOP-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_STOP-val is deprecated.  Use copernicus_msgs-msg:M_STOP instead.")
  (M_STOP m))

(cl:ensure-generic-function 'M_BREAK-val :lambda-list '(m))
(cl:defmethod M_BREAK-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_BREAK-val is deprecated.  Use copernicus_msgs-msg:M_BREAK instead.")
  (M_BREAK m))

(cl:ensure-generic-function 'M_SETRPM-val :lambda-list '(m))
(cl:defmethod M_SETRPM-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_SETRPM-val is deprecated.  Use copernicus_msgs-msg:M_SETRPM instead.")
  (M_SETRPM m))

(cl:ensure-generic-function 'M_GETRPM-val :lambda-list '(m))
(cl:defmethod M_GETRPM-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_GETRPM-val is deprecated.  Use copernicus_msgs-msg:M_GETRPM instead.")
  (M_GETRPM m))

(cl:ensure-generic-function 'M_PARAM-val :lambda-list '(m))
(cl:defmethod M_PARAM-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:M_PARAM-val is deprecated.  Use copernicus_msgs-msg:M_PARAM instead.")
  (M_PARAM m))
...
(cl:defmethod PRECHARGE_FUSE-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:PRECHARGE_FUSE-val is deprecated.  Use copernicus_msgs-msg:PRECHARGE_FUSE instead.")
  (PRECHARGE_FUSE m))

(cl:ensure-generic-function 'MOTOR_FUSE-val :lambda-list '(m))
(cl:defmethod MOTOR_FUSE-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:MOTOR_FUSE-val is deprecated.  Use copernicus_msgs-msg:MOTOR_FUSE instead.")
  (MOTOR_FUSE m))

(cl:ensure-generic-function 'LED_STATE-val :lambda-list '(m))
(cl:defmethod LED_STATE-val ((m <Diagnostics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader copernicus_msgs-msg:LED_STATE-val is deprecated.  Use copernicus_msgs-msg:LED_STATE instead.")
  (LED_STATE m))

...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/copernicus/copernicus_ws_farm/src/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/copernicus/copernicus_ws_farm/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/copernicus/copernicus_ws_farm/install)
...
if(NOT "/home/copernicus/copernicus_ws_farm/devel/include;/home/copernicus/copernicus_ws_farm/src/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/copernicus/copernicus_ws_farm/devel/include;/home/copernicus/copernicus_ws_farm/src/diff_drive_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/copernicus/copernicus_ws_farm/src/diff_drive_controller/${idir}'.  ${_report}")
    endif()
...
set(diff_drive_controller_EXPORTED_TARGETS "diff_drive_controller_generate_messages_cpp;diff_drive_controller_generate_messages_eus;diff_drive_controller_generate_messages_lisp;diff_drive_controller_generate_messages_nodejs;diff_drive_controller_generate_messages_py;diff_drive_controller_gencfg")

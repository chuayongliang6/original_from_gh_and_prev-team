// Generated by gencpp from file copernicus_msgs/Diagnostics.msg
// DO NOT EDIT!


#ifndef COPERNICUS_MSGS_MESSAGE_DIAGNOSTICS_H
#define COPERNICUS_MSGS_MESSAGE_DIAGNOSTICS_H
...
struct Diagnostics_
{
  ...
  typedef boost::shared_ptr< ::copernicus_msgs::Diagnostics_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::copernicus_msgs::Diagnostics_<ContainerAllocator> const> ConstPtr;

}; // struct Diagnostics_

typedef ::copernicus_msgs::Diagnostics_<std::allocator<void> > Diagnostics;

typedef boost::shared_ptr< ::copernicus_msgs::Diagnostics > DiagnosticsPtr;
typedef boost::shared_ptr< ::copernicus_msgs::Diagnostics const> DiagnosticsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::copernicus_msgs::Diagnostics_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::copernicus_msgs::Diagnostics_<ContainerAllocator1> & lhs, const ::copernicus_msgs::Diagnostics_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::copernicus_msgs::Diagnostics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::copernicus_msgs::Diagnostics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::copernicus_msgs::Diagnostics_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
{
  ...
  static const char* value(const ::copernicus_msgs::Diagnostics_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x724ceb6ccb5d72d3ULL;
  static const uint64_t static_value2 = 0xaf9209169201c96cULL;
};

template<class ContainerAllocator>
struct DataType< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::copernicus_msgs::Diagnostics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::copernicus_msgs::Diagnostics_<ContainerAllocator>& v)
  {
...
#endif // COPERNICUS_MSGS_MESSAGE_DIAGNOSTICS_H

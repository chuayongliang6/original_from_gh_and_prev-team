...
#include <copernicus_hardware/controlsConfig.h>
#include <dynamic_reconfigure/IntParameter.h>
#include <dynamic_reconfigure/Reconfigure.h>
#include <dynamic_reconfigure/Config.h>
#include "copernicus_hardware/queue.h"
#include "copernicus_hardware/tableToRos.h"
#include "copernicus_hardware/constants.h"
#include "copernicus_hardware/copernicusDataStruct.h"
#include "copernicus_hardware/conversion.h"
...
{
	ros::init(argc,argv,"copernicus_control");
	ROS_DEBUG("START\n");
	...
	while(ros::ok())
	{
		...
		if(rpmAvailable == true)
		{
			...
			//ROS_WARN("RPM : %x %x %x %x ",tempData[8],tempData[9],tempData[10],tempData[11]);
			//ROS_WARN("---------------------------------------------------------");
